"use strict";
(self["webpackChunkhajimari"] = self["webpackChunkhajimari"] || []).push([["vendors-node_modules_storybook-addon-designs_esm_register_components_Figspec_js"],{
...
const ErrorMessage = ({ title, children }) => html `
...
const CSSProperty = (cssProperty) => {
    ...
    return html `<div class="css-property" @click=${() => copy_to_clipboard(getStyleRule(cssProperty))}>
...
const es2015_FigspecFrameViewer = (0,react.forwardRef)((_a, ref) => {
    ...
    const [refNode, setNode] = (0,react.useState)(null);
    (0,react.useImperativeHandle)(ref, () => refNode, [refNode]);
    const refCb = (0,react.useCallback)((node) => {
        if (node) {
            setNode(node);
            node.nodes = nodes;
    ...
    return ((0,react.createElement)("figspec-frame-viewer", Object.assign({ ref: refCb, class: className, "pan-speed": panSpeed, "zoom-margin": zoomMargin, "zoom-speed": zoomSpeed }, rest)));
});
const es2015_FigspecFileViewer = (0,react.forwardRef)((_a, ref) => {
    ...
    return ((0,react.createElement)("figspec-file-viewer", Object.assign({ ref: refCb, class: className, "pan-speed": panSpeed, "zoom-margin": zoomMargin, "zoom-speed": zoomSpeed }, rest)));
});
...
function getAccessToken(cfg) {
    ...
    try {
        return (_a = {"NODE_ENV":"development","NODE_PATH":[],"STORYBOOK":"true","PUBLIC_URL":"."}.STORYBOOK_FIGMA_ACCESS_TOKEN) !== null && _a !== void 0 ? _a : null;
    }
    catch (err) {
        return null;
    }

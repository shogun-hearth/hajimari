...
Available variants include: `primary`, `secondary`, `filled`, `textLight`, and `textDark`.
...
<Story name="Variants">
  ...
  <div style={{ marginRight: 16 }} />
  <Button color="primary" variant="textLight">
    TextLight
  </Button>
  <div style={{ marginRight: 16 }} />
  <Button color="primary" variant="textDark">
    TextDark
  </Button>
</Story>
...
<Story name="Colors">
  <Button color="basic" variant="primary">
    Basic
  </Button>
  <div style={{ marginRight: 16 }} />
  <Button color="primary" variant="secondary">
  ...
  <div style={{ marginRight: 16 }} />
  <Button color="warning" variant="primary">
    Warning
  </Button>
  <div style={{ marginRight: 16 }} />

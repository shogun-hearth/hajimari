...
<Story name="Variants">
  ...
  <div style={{ marginRight: 16 }} />
  <Button color="blue" variant="text" bg="dark">
    Text (on Dark)
  </Button>
</Story>
...
<Story name="States">
  ...
  <div style={{ marginRight: 16 }} />
  <Button color="blue" variant="secondary" disabled>
    Disabled
  </Button>
</Story>
...
A button accepts a `color` prop which is one of `blue`, `greyscale`,
`green`, `yellow`, and `red`. The examples below show the available colors

...
declare const Dialog: ({ fullWidth, maxWidth, children, ...props }: DialogProps$2) => JSX.Element;
...
declare const DialogTopContent: ({ children, showCloseButton, onClose, backlink, backlinkAction, title, ...props }: DialogTopContentProps) => JSX.Element;
